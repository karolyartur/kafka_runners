    ...
    def msg_to_command(self, msg):
        ...
        try:
            ...
            try:
                ...
                if use_gpu:
                    cmd = [self.blender, scene, '--background', '--python', 'render_frames.py', '--', '-fs', '{}'.format(frame_start), '-fn', '{}'.format(frame_num), '-o', '{}'.format(self.temp_render_output), '--gpu', '--cycles-device', 'CUDA']
                else:
